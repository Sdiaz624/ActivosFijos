...
--%>
    <form class="form-horizontal" method="post" action="jsp/Egresado/procesarRegistro.jsp"  >
       ...
       <div id="tab2" style="display:none"> 
        ...
        <center><button type="button" class="btn btn-default" onclick="mostrarTab('tab1', 'tab2', 'tab3', 'li3', 'li1', 'li2')">Información Personal</button>
        <button type="button" class="btn btn-default" onclick="mostrarTab('tab3', 'tab2', 'tab1', 'li3', 'li1', 'li2')">Información Academica</button>
        <button type="button" class="btn btn-default" onclick="mostrarTab('tab2', 'tab1', 'tab3', 'li2', 'li1', 'li3')">Información laboral</button>
        </center>
