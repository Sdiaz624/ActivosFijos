...
--%>
    <form class="form-horizontal" method="post" action="Egresado/procesarActualizacion.jsp" >
        ...
        <div id="tab3" style="display:none">
            ...
            <center>
                <button type="button" class="btn btn-default" onclick="mostrarTab('tab1', 'tab2', 'tab3', 'li2', 'li1', 'li3')">Información Laboral</button>
            <button type="button" class="btn btn-default" onclick="mostrarTab('tab2', 'tab1', 'tab3', 'li2', 'li1', 'li3')">Información Laboral</button>
            <button type="button" class="btn btn-default" onclick="mostrarTab('tab3', 'tab2', 'tab1', 'li3', 'li1', 'li2')">Información Académica</button>
            <br>
            <br>
