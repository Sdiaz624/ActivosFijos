...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 02-10-2017 a las 01:01:50
...
INSERT INTO `activos` (`id`, `Nombre`, `NumeroInt`, `Descripcion`, `Tipo`, `Serial`, `Peso`, `Alto`, `Largo`, `Valor`, `FechaCompra`, `FechaBaja`, `Estado`, `Color`, `Persona`, `Area`) VALUES
(1, 'Televisor', 1, 'Televisor sala 1', 'bienes', '9090', 9.99, 0.50, 0.50, 20000.00, '2017-09-07', '2017-09-08', 'Activo', 'rojo', NULL, 1);
